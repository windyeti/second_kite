ThinkingSphinx::Index.define :ad, with: :active_record do
  ...
  indexes kites.kite_name.approve, as: :kite_name_approve
  ...
  indexes boards.board_name.approve, as: :board_name_approve
  ...
  indexes bars.bar_name.approve, as: :bar_name_approve
  ...
  indexes stuffs.stuff_name.approve, as: :stuff_name_approve
